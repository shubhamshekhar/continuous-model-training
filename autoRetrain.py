...
def main(_):
    ...
    with open('non_swiggy_downloaded_urls.txt') as f:
        line_count = 0
        for line in f:
            line_count += 1
...
def train_model():
  ...
  with tf.Session(graph=graph) as sess:
    ...
    #firebase = firebase.FirebaseApplication('https://drivermonitoringsystem.firebaseio.com/')  ##ADDED FOR FIREBASE APPLICATION
    #firebase.put('TrainingStatus','trainingOutput',time.time())                 #added this line
